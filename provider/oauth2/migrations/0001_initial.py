    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(db_index=True, default=utils.long_token, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.CharField(default=utils.short_token, max_length=255)),
                ('client_secret', models.CharField(default=utils.long_token, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=utils.long_token, max_length=255)),
